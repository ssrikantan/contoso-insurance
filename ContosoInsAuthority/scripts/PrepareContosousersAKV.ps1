...
$applicationName     = 'spakvcontosousers'
...
# **********************************************************************************************
$location            = 'Southindia'                          # Get-AzureLocation
...
$myCertThumbprint = (New-SelfSignedCertificate -Type Custom -Subject "$certificateName"-KeyUsage DigitalSignature -KeyAlgorithm RSA -KeyLength 2048 -CertStoreLocation "Cert:\CurrentUser\My").Thumbprint
...
# Specify full privileges to the vault for the End User portal application
